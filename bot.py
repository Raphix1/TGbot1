...
bot = telebot.TeleBot('7494252760:AAE6r6cFMeBemGZHtwsPC13NIdWFiTwf5NA')
users = {}
admins = {}
...
def get_user_loc(msg, text):
    ...
    if msg.location:
        ...
        bot.send_message(-1002163694220, text)
        bot.send_location(-1002163694220, latitude=msg.location.latitude,
